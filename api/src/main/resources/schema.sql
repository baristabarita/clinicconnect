...
INSERT INTO `users` VALUES (1,'john.doe@example.com','John','Doe','A',30,'Male','1234567890','1993-05-15','$2a$10$cBhMYB1LlMyvSuCLYXVrf.6XYWjK1cJFAYiVicKEgW6a4zYKKCekG','PATIENT',NULL,NULL),(2,'jane.doe@example.com','Jane','Doe','B',24,'female','1234567890','1993-05-15','$2a$10$SfZMJlqnW1Jk3RLrcbIEIeSHi/D8wO1/Hsbp1.069u261w.9bTSZe','PATIENT',NULL,NULL),(3,'bob.doc@example.com','Bob','Bob','B',24,'male','1234567890','1993-05-15','$2a$10$rvYtLpliJ1AT87KQhj38ueAu4DYAMtrpzd0WGKHRieFqXzVhbK02e','STAFF',NULL,NULL),(4,'mark.fish@example.com','Mark','Fish','P',30,'male','1234567890','1993-05-15','$2a$10$mYOUyDxtaQFuiNLQzNEdAe5MSZyU9yXrL4zYgqN6rMOWlGXTa0yse','STAFF',NULL,NULL),(5,'michael.desanta@email.com','Michael','DeSanta','E',50,'MALE','09999999999','1994-12-03','$2a$10$5LG.0ZC/lAGR03Du6avSReP1S9VgRnY742m/hb9nsOl/m8ASt0w92','STAFF',NULL,NULL),(6,'karylle.bernate@email.com','Karylle','Bernate','',23,'FEMALE','09123456789','2003-08-08','$2a$10$z6FytMZ4Wi2e48XP8dfZeOAmt2AeU7bsNswAVDk6YkLZr5CStTO/S','PATIENT',NULL,NULL),(7,'shane@email.com','Shane','Dave','',23,'MALE','09156782341','2003-02-22','$2a$10$nRhtWKe6N6KzER5TBVS/aOU8FTnjPtN0SP1FFIbILFvxxYCFO4Fye','PATIENT',NULL,NULL),(8,'mark.david@emai.com','Mark','David','',26,'MALE','09934528456','1995-10-17','$2a$10$ljmmQgCxlqRlK9QhP5S5N..q2QSYzi72HwflUekJL0xbzmpHDtNdq','PATIENT',NULL,NULL);

INSERT INTO `doctors` VALUES (1,'Bob','Martinez','','bb.doc@email.com','Surgeon','AVAILABLE','https://www.pngall.com/wp-content/uploads/2018/05/Doctor-PNG-File-Download-Free.png',NULL,0),(2,'Sarah','Louis','','sarahlouis@gmail.com','Cardiologist','AVAILABLE','https://gregoryjhickenmd.com/wp-content/uploads/2018/04/Nurse-Clipboard-Dr-Hicken.png',NULL,0),(9,'Marcus','Vasquez','','mc@doc.email.com','Cardiololigst','AVAILABLE','https://pngimg.com/d/doctor_PNG15992.png',NULL,0);

INSERT INTO `doctor_availability` VALUES (1,1,'2024-12-02','2024-12-18','AVAILABLE',NULL),(2,1,'2024-12-24','2024-12-31','ON_LEAVE',NULL),(6,1,'2024-01-01','2024-06-30','AVAILABLE','Regular clinic hours'),(7,2,'2024-01-01','2024-06-30','AVAILABLE','Regular clinic hours'),(8,1,'2024-02-14','2024-02-21','ON_LEAVE','Annual vacation'),(9,2,'2024-03-10','2024-03-17','ON_LEAVE','Conference attendance'),(10,1,'2024-04-01','2024-04-30','PARTIALLY_AVAILABLE','Afternoon sessions only'),(11,2,'2024-05-15','2024-05-30','PARTIALLY_AVAILABLE','Morning sessions only');
